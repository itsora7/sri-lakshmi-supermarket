		...
		<div class="row main">
			...
			<div class="col-md-9">
				<?php
					...
					if($count == 0)
						echo "<h4 class='text-warning'>No Feedback in Database</h4>";
					else {
						echo "<table class='table table-striped table-bordered table-hover'><tr><th>Feedback ID<th>User Name<th>Message<th>Submission Date</tr>";					
						while($row = mysqli_fetch_array($result))
							echo "<tr><td>".$row[0]."<td>".$row[1]."<td>".$row[3]."<td>".$row[2]."</td>";
					}
				?>
			</div>
		</div>	
