					...
					<form class="" method="post" action="ProcessCategory.php" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<!--span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span-->
									<input type="text" class="form-control" name="catdescription" id="cat_desc"  placeholder="Description"/>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="submit" id="button" class="btn btn-primary btn-lg btn-block login-button" value="Submit" name="submit">
						</div>
					</form>
				</div>
			</div>
